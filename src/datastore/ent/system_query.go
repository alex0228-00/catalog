...
func (sq *SystemQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SystemQuery) FirstIDX(ctx context.Context) string {
...
func (sq *SystemQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SystemQuery) OnlyIDX(ctx context.Context) string {
...
func (sq *SystemQuery) All(ctx context.Context) ([]*System, error) {
	...
	return withInterceptors[[]*System](ctx, sq, qr, sq.inters)
}
...
func (sq *SystemQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (sq *SystemQuery) IDsX(ctx context.Context) []string {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SystemQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, sq, querierCount[*SystemQuery](), sq.inters)
}
...
func (sq *SystemQuery) Clone() *SystemQuery {
	...
	return &SystemQuery{
		config:     sq.config,
		ctx:        sq.ctx.Clone(),
		order:      append([]system.OrderOption{}, sq.order...),
...
func (sq *SystemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*System, error) {
	var (
		nodes = []*System{}
		_spec = sq.querySpec()
	)
...
func (sgb *SystemGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*SystemQuery, *SystemGroupBy](ctx, sgb.build, sgb, sgb.build.inters, v)
}

func (sgb *SystemGroupBy) sqlScan(ctx context.Context, root *SystemQuery, v any) error {
...
func (ss *SystemSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*SystemQuery, *SystemSelect](ctx, ss.SystemQuery, ss, ss.inters, v)
}

func (ss *SystemSelect) sqlScan(ctx context.Context, root *SystemQuery, v any) error {
