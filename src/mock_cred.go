...
//
//	mockgen -source=cred.go -destination=mock_cred.go -package=src
//
...
func (m *MockCredential) Auth() *http.Client {
	m.ctrl.T.Helper()
...
func (mr *MockCredentialMockRecorder) Auth() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Auth", reflect.TypeOf((*MockCredential)(nil).Auth))
}
